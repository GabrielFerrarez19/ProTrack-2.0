      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Gerencie integrações e conexões da sua aplicação.
          </p>
        </div>
      </div>
        ...
        <TabsContent value="whatsapp" className="space-y-4 mt-4">
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>
                A conexão é feita via WhatsApp Web. Mantenha seu celular
                conectado à internet para que as mensagens sejam enviadas
                corretamente.
              </p>
              <p>
                Você pode desconectar a qualquer momento por aqui ou diretamente
                pelo aplicativo do WhatsApp em{" "}
