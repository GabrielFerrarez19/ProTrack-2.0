...
exports.getTotalVendasVencidas = exports.getVendasVencidas = exports.getFormasPagamentoController = exports.getVendasDashboardController = exports.atualizarVenda = exports.getAllVendas = exports.getTotalVendas = exports.criarVenda = void 0;
...
const getAllVendas = async (req, res) => {
    try {
        ...
        const vendas = (0, functions_1.mapVendasComItensF)(rows);
...
const getVendasDashboardController = async (req, res) => {
    try {
        const vendas = await (0, venda_service_1.getVendasDashboard)();
        res.status(200).json(vendas);
    }
    catch (err) {
...
exports.getVendasDashboardController = getVendasDashboardController;
const getFormasPagamentoController = async (req, res) => {
    try {
        const formas = await (0, venda_service_1.getFormasPagamento)();
...
exports.getFormasPagamentoController = getFormasPagamentoController;
const getVendasVencidas = async (req, res) => {
    try {
        const rows = await (0, venda_service_1.getVendasVencidasDb)();
        const vendas = (0, functions_1.mapVendasComItensF)(rows);
        res.status(200).json(vendas);
    }
    catch (err) {
...
exports.getVendasVencidas = getVendasVencidas;
const getTotalVendasVencidas = async (req, res) => {
    try {
        const total = await (0, venda_service_1.getTotalVendasVencidasDb)();
...
exports.getTotalVendasVencidas = getTotalVendasVencidas;
